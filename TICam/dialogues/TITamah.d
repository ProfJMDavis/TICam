...
IF ~~ THEN DO ~SetGlobal("TICMeet","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END

IF ~~ THEN BEGIN a3c
SAY~*Reading.* And to think I used to worry about what my hair looked like in the mornings!~
IF ~~ THEN DO ~SetGlobal("TICHair","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END

IF ~~ THEN BEGIN a3d
SAY~*Reading.* Yes... He was sweet about that. Camryn was the first man I've met who looked at my eyes rather than my chest...~
IF ~~ THEN DO ~SetGlobal("TICEyes","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END
...
IF ~~ THEN DO ~SetGlobal("TICLife","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END
...
IF ~~ THEN DO ~SetGlobal("TICFriends","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END
...
IF ~~ THEN DO ~SetGlobal("TICSex","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END
...
IF ~~ THEN DO ~SetGlobal("TICFight","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END

IF ~~ THEN BEGIN a3i
SAY~*Reading.* Oh, my heart! Children! He remembered that conversation after all. I thought it was just me wanting a family...~
IF ~~ THEN DO ~SetGlobal("TICFamily","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END
...
IF ~~ THEN DO ~SetGlobal("TICBooks","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END

IF ~~ THEN BEGIN a3k
SAY~*Tamah reads.* I never thought he was heartless... Only stubborn.*~
IF ~~ THEN DO ~SetGlobal("TICMyLove","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END

IF ~~ THEN BEGIN a3l
SAY~*Tamah blushes deeply, then closes and reseals the letter without saying a word.*~
IF ~~ THEN DO ~SetGlobal("TICBed","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END

IF ~~ THEN BEGIN a3m
SAY~*Tamah looks up from the letter.* That's Camryn for you. Such a romantic!~
IF ~~ THEN DO ~SetGlobal("TICMarriage","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END
...
IF ~~ THEN DO ~SetGlobal("TICArgument","LOCALS",1) IncrementGlobal("TISCRLLove","GLOBAL",1)~ + a2c
END
...
++ ~I wouldn't wait any longer, Tamah. It's been thirty years: isn't that enough?~ DO ~IncrementGlobal("TITamah","GLOBAL",1)~ + a3y
END
...
IF ~!Dead("TICam") Global("TITamah","GLOBAL",4)~ THEN BEGIN t1
...
IF ~Dead("TICam") Global("TITamah","GLOBAL",4)~ THEN BEGIN t2
